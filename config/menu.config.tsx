...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  { heading: 'Thông tin' },
  {
    ...
    children: [
      ...
      { title: 'Giá đầu vào', path: '/khach-san/gia-dau-vao' },
      { title: 'Giá đầu ra', path: '' },
      { title: 'Hạng phòng', path: '' },
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Đơn giá/km', path: '' },
      { title: 'Định mức km', path: '' },
      { title: 'Giá đầu vào theo package', path: '' },
       { title: 'Lộ trình tuyến', path: '' },
        { title: 'Lộ trình điểm', path: '' },
         { title: 'Danh sách đội xe', path: '' },
  ...
  { title: 'Đặt đoàn', icon: ScrollText, disabled: true },

    { heading: 'Đặt dịch vụ' },


  { title: 'Khách sạn', icon: ScrollText, disabled: true },
  
  { title: 'Xe', icon: ScrollText, disabled: true },
   { title: 'Nhà hàng', icon: ScrollText, disabled: true },
    { title: 'Tàu tiếng', icon: ScrollText, disabled: true },
];
